    ...
    <nav>
        ...
        <div class="menu">
            <ul>
				...
				<li><a class="active" href="perfiladm.php">Perfil</a></li>
	...
	<div align="center">
		...
		<?php
			...
			while($row_utilizador = mysqli_fetch_assoc($resultado_utilizador)){
				...
				echo "<a href='editar_adm.php?idUtilizador=". $row_utilizador ['idUtilizador']."'> <img border='0' alt='Editar' src='img/edit.png' width='25' height='25'> </a>";
			}
		?>
	</div>
<footer>
